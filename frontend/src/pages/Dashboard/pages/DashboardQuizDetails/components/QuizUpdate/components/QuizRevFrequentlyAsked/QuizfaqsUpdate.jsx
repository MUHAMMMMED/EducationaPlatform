...
export default function QuizfaqsUpdate({ item, fetchQuiz }) {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await AxiosInstance.put(`${Config.baseURL}/Quiz/faq_list/${item.id}/`, formData);
  ...
  const handleDelete = async () => {
    try {
      await AxiosInstance.delete(`${Config.baseURL}/Quiz/faq_list/${item.id}/`);
      fetchQuiz();
    } catch (error) {
