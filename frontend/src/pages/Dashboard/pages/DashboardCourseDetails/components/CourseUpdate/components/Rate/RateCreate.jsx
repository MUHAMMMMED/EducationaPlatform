...
const RateCreate = ({ Course, fetchCourse }) => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            await AxiosInstance.post(`${Config.baseURL}/Courses/rate_list/`, formData);
            setFormData({ message: '', rate_number: '', course: Course.id, student: '' });
                    ...
                    <div className="FOrm-container">
                        <div className="form-container-half" style={{ width: '100%' }}>
                            ...
                            <select className="Action-Box" style={{ width: '98%', marginTop: '5px' }} onChange={handleStudentSelection} value={formData.student.id}>
                                ...
                                {Course.student && Course.student.map(stu => (
