...
const LiveCourseReviewCreate = ({ courseId, fetchCourse }) => {
  const [showModalReviewCreate, setShowModalReviewCreate] = useState(false);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await AxiosInstance.post(`${Config.baseURL}/LiveCourses/live-course-reviews/`, formDataObj, {
                headers: {
...
export default LiveCourseReviewCreate;
