...
const BaseFormCreate = ({ liveCourses,fetchCourse }) => {
    const [showModalBaseCreate, setShowModalBaseCreate] = useState(false);
    ...
    const [formData, setFormData] = useState({
        ...
        author_Description2: '',
        author_Description3: '',
        Title_Achievements_Hour: '',
        Number_Achievements_Hour: '',
        Title_Achievements_Book: '',
        Number_Achievements_Book: '',
        Title_Achievements_Grade: '',
        Number_Achievements_Grade: '',
        title_Learning_Path: '',
        Title_CountdownHead: '',
        ...
        expired: '',
        sale: '',
        join_telegram_public: '',
        join_whatsapp_public: ''
    });
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
            ...
            await AxiosInstance.post(`${Config.baseURL}/LiveCourses/base/`, formDataObj, {
                headers: {
                    'Content-Type': 'multipart/form-data',
                },
            });

            setShowModalBaseCreate(false);
            fetchCourse();
            // Optionally, perform any other actions after successful creation
        } catch (error) {
...
<button onClick={() => setShowModalBaseCreate(true)} className="Creat_button">Create</button>
<div className={`modal ${showModalBaseCreate ? 'show' : ''}`}> 

<form className="modal-content animate" onSubmit={handleSubmit} encType="multipart/form-data">
<h2 style={{ textAlign: 'center', padding: '15px' }}>Create base</h2>
...
<input type="number" style={{width:'100%'}} name="Number_Achievements_Hour" value={formData.Number_Achievements_Hour} onChange={handleChange} placeholder="Number Achievements Hour" />
</div>
</div>
<div className="FOrm-container">
<div className="form-container-half">
...
<input type="number"style={{width:'100%'}} name="Number_Achievements_Book" value={formData.Number_Achievements_Book} onChange={handleChange} placeholder="Number Achievements Book" />
</div>
</div>
<div className="FOrm-container">
<div className="form-container-half">
...
<input type="number" style={{width:'100%'}} name="Number_Achievements_Grade" value={formData.Number_Achievements_Grade} onChange={handleChange} placeholder="Number Achievements Grade" />
 </div>
</div>
