...
export default function TeacherList() {
    ...
    const fetchUser = async () => {
        try {
            const response = await AxiosInstance.get(`${Config.baseURL}/dashboard/teacher_filter/`, {
            ...
            <div class="projects">
                <div class="projects-inner">
                    <header class="Projects-header">
                        <div class="Projects-header-Title"><FaUserGraduate /> {results.user_count} Teachers</div>
