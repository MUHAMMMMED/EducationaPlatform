          ...
          <div className="row_speaker">
            <div className="row_speaker_col ">
              <div class="  image_widget">
                {data?.Base?.author_Image && (<img className='image_widget_img' src={`${Config.mediaURL}/${data?.Base?.author_Image}`} alt={data?.Base?.title_Speaker} />)} </div></div>
                ...
                <div class="col col-lg-4" key={item.id}>
                  <div class="mentor_item">
                    <div class="mentor_image">  {item?.Teacher?.height_image && (
                      <img style={{ width: '100%' }} src={`${Config.mediaURL}/${item?.Teacher?.height_image}`} alt={item?.Teacher?.user_full_name} />)}</div>
