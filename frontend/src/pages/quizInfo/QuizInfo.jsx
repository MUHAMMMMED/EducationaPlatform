...
import { AuthorItem, Banner, Button, CardWrapper, Content, DescriptionWrapper, Enroll, H4, InfoAuthor, InfoPrice, LI_Span, L_I, P, Price, ReviewsSection, RowInfo, Section, Sidebar, SidebarWidget, Span, Strong, TabDescription, Title, UL } from './styles';
            ...
            <Sidebar>
              <SidebarWidget>
                ...
                <div ><UL>
                  ...
                  <L_I><Span> <FaUserGraduate /></Span><Strong>Total</Strong> <LI_Span>{examDetails.Enroll} Enrolled</LI_Span></L_I>
                  <L_I><Span><BiListOl /></Span><Strong> Total :</Strong> <LI_Span>{examDetails.questions_count} Questions  </LI_Span></L_I>
                  <L_I><Span><CgTime /> </Span><Strong>Duration :</Strong> <LI_Span>{examDetails.time_to_answer} mins</LI_Span></L_I>
                  <L_I><Span><PiTimer /> </Span><Strong>   Tries :</Strong> <LI_Span>{examDetails.tries} times</LI_Span></L_I>
                  <L_I><Span> <IoIosSync /></Span><Strong> Updated</Strong> <LI_Span>{examDetails.updated}</LI_Span></L_I>
                </UL>
                </div>
                <>
