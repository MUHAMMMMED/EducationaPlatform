...
export default function LoginLiveCourse() {
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        if (res.status === 200) {
          ...
          await  navigate(`/Pay_LiveCourse/${courseId}/`);
          ...
          <div>
            <form action="" onSubmit={handleSubmit}>
              ...
              <div className="single-form">
                ...
                <Link to={`/Signup_LiveCourse/${courseId}/`} className="Btn Btn-secondary">Create an account now</Link>
              </div>
