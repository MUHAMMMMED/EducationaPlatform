...
function SidebarFilter() {
    ...
    const handleLevelChange = (selectedLevel) => {
        ...
        if (levelChange.includes(selectedLevel)) { setLevelChange(levelChange.filter(l => l !== selectedLevel));

        } else {  setLevelChange([...levelChange, selectedLevel]);
    ...
    const handlePriceChange = (selectedPrice) => {
        ...
        if (priceChange.includes(selectedPrice)) { setPriceChange(priceChange.filter(p => p !== selectedPrice));
