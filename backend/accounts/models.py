...
class UserManager(BaseUserManager):
    ...
    def create_user(self, email, first_name, last_name, password, user_type='S', **extra_fields):
        if email:
...
class User(AbstractBaseUser,PermissionsMixin):
    ...
    width_image = models.ImageField(upload_to='user_images/', null=True, blank=True, )
    height_image = models.ImageField(upload_to='user_images/', null=True, blank=True, )
    ...
    user_type = models.CharField(max_length=1, choices=[('S', 'Student'), ('T', 'Teacher'), ('M', 'Manager')], default='S')
