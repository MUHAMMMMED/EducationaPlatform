...
class User_Serializer(serializers.ModelSerializer):
    ...
    region = serializers.CharField(source='region.dictionary.name', read_only=True)
    city = serializers.CharField(source='city.dictionary.name', read_only=True)

    class Meta:
        model = User
        fields = [ 'date_joined','last_login','id','first_name','last_name','user_full_name','phone', 'width_image' ,'height_image','email','job_title','user_type', 'country', 'region', 'city']
...
class UserUpdateSerializer(serializers.ModelSerializer):
    class Meta:
        model = User
        fields = [ 'id','first_name','last_name',  'phone', 'width_image' ,'height_image', 'job_title' ]
...
class Country_Serializer(serializers.ModelSerializer):
    dictionary = Dictionary_Serializer()
    class Meta:
        model = Country
        fields = '__all__'
...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ['user_full_name','job_title',  'width_image','height_image' ]
...
class UserSerializerwithId(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ['user_full_name', 'width_image','height_image', 'id']

class UserRegisterSerializer(serializers.ModelSerializer):
    password = serializers.CharField(max_length=68, min_length=6, write_only=True)
    password2 = serializers.CharField(max_length=68, min_length=6, write_only=True)
    user_type = serializers.CharField(max_length=1, default='S')  # Add user_type field
